                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <button type="button" class="btn btn-primary btn-sm" data-remote="{{ route('transactions.show', $item->id) }}" data-toggle="modal" data-target="#mymodal" data-title="Detail Transaksi {{ $item->uuid }}">
                                            Detail
                                        </button>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center p-5">Transaksi belum tersedia</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
